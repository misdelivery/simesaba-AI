...
def load_data():
    with st.spinner(text="読み込み中・・・"):
        ...
        storage_context = StorageContext.from_defaults(
            docstore=SimpleDocumentStore.from_persist_dir(persist_dir= os.path.join(os.getcwd(), dest_path, 'storage_context')),
            vector_store=SimpleVectorStore.from_persist_dir(persist_dir= os.path.join(os.getcwd(), dest_path, 'storage_context')),
            index_store=SimpleIndexStore.from_persist_dir(persist_dir= os.path.join(os.getcwd(), dest_path, 'storage_context')),
        )
